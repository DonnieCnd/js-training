[![Build Status](https://travis-ci.org/DonnieCnd/js-training.svg?branch=master)](https://travis-ci.org/nan-academy/js-training)
## Setup
First, [**fork**](https://github.com/DonnieCnd/js-training/fork?fragment=1) this repository.
